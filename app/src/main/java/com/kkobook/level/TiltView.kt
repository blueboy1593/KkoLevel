...
class TiltView(context: Context?) : View(context) {
    ...
    override fun onDraw(canvas: Canvas?) {
        // 바깥 원
        canvas?.drawRect(100f, 300f, 200f, height - 200f, blackPaint)
        canvas?.drawRect(200f, 100f, width - 200f, 200f, blackPaint)
        canvas?.drawCircle(cX, cY, 300f, blackPaint)
        ...
        // 막대 십자가
        canvas?.drawLine(150f - 20, (height + 100f) / 2, 150f + 20, (height + 100f) / 2, blackPaint)
        canvas?.drawLine( 150f, (height + 100f) / 2 - 20 , 150f, (height + 100f) / 2 + 20, blackPaint)
    }
